...
window.ADP_CANVAS = (function () {
  ...
  var STYLE = ''
    ...
    + '.mx-cbar{display:flex;align-items:center;gap:12px;border:1px solid var(--line,#d4d4d8);border-radius:14px;padding:14px 18px;cursor:pointer;background:var(--soft,#e6e6e8)}'
    ...
    + '.mx-eixomod{background:var(--card,transparent);border:1px solid var(--line,#d4d4d8);border-radius:14px;overflow:hidden}'
    ...
    + '.mx2-cq{font-size:13.5px;color:var(--muted,#71717a);margin:7px 0 18px;line-height:1.5;max-width:64ch}'
    ...
    + '.mx2-seclink{font-size:12.5px;font-weight:700;color:var(--muted,#71717a);text-decoration:underline;text-underline-offset:2px;background:none;border:none;cursor:pointer;padding:2px 0}'
